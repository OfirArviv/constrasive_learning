...
NUM_CORES = 16
NUM_GPUS = 1
MEMORY = '512g'  # amount of memory we will request for the job
...
if __name__ == '__main__':
    ...
    for dataset in ["banking77", "sst2", "mnli", "mrcp"]: # "snli", "boolq", "wnli", "cola", "mrpc", "qqp",
        ...
        command_to_run = f'python {full_fname_to_run} train -d {dataset} -o {data_dir}'
